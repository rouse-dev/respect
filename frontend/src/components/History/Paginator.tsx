...
const Paginator: React.FC<PaginatorInterface> = ({
  ...
  <ReactPaginate
    ...
    previousClassName={'w-10 h-10 flex items-center justify-center bg-gray-100 hover:bg-indigo-600 text-gray-600 rounded-full transition-colors '}
    nextClassName={'w-10 h-10 flex items-center justify-center bg-gray-100 hover:bg-indigo-600 text-gray-600 rounded-full transition-colors'}
    pageClassName={'w-10 h-10 flex items-center justify-center bg-white border border-gray-300 text-gray-700 hover:bg-indigo-100 hover:text-indigo-600 rounded-full transition-colors '}
