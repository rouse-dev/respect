...
const EditStudents = ({ isOpen }: EditStudentsInterface) => {
  const { students, setPopupActive } = useAppContext();
    ...
    >
      ...
      {students.map((student, index) => (
        <div
          ...
          } transition-transform flex flex-col md:flex-row items-center gap-3 md:gap-5 p-3 md:p-5 shadow-[inset_0px_0px_24px_var(--respect-purple-dark)] rounded-md text-xl`}
        >
