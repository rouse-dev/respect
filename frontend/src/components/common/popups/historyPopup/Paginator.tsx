...
const Paginator: React.FC<PaginatorInterface> = ({
  ...
  <ReactPaginate
    ...
    previousClassName={'w-10 h-10 cursor-pointer flex items-center justify-center bg-gray-100  text-gray-600 rounded-full transition-colors '}
    nextClassName={'w-10 h-10 flex cursor-pointer items-center justify-center bg-gray-100  text-gray-600 rounded-full transition-colors'}
    pageClassName={'w-10 h-10 flex cursor-pointer items-center justify-cente text-white  border border-gray-300 text-gray-700 hover:bg-indigo-100 hover:text-indigo-600 rounded-full transition-colors '}
